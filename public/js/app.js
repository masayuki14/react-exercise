...
},{"./menu.jsx":2,"react":158}],2:[function(require,module,exports){
var React = require('react');

var BasicMenu = React.createClass({displayName: "BasicMenu",
  render: function() {
    return (
      React.createElement("ul", null, "基本設定", 
        React.createElement("li", null, "SIMアドレス登録"), 
        React.createElement("li", null, "返信テンプレート"), 
        React.createElement("li", null, "稼働設定")
      )
    );
  }
});

var LogMenu = React.createClass({displayName: "LogMenu",
  render: function() {
    return (
      React.createElement("ul", null, "ログ関連", 
        React.createElement("li", null, "メール送信キュー"), 
        React.createElement("li", null, "ログ検索"), 
        React.createElement("li", null, "効果集計")
      )
    );
  }
});

var MenuArea = React.createClass({displayName: "MenuArea",
  render: function() {
    return (
      React.createElement("div", {className: "menu-area"}, 
        React.createElement(BasicMenu, null), 
        React.createElement(LogMenu, null)
      )
    );
  }
});
...
},{"react":158}],3:[function(require,module,exports){
